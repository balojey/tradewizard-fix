-- ============================================================================
-- Recreate all performance views (dropped in 20260325000000)
-- Uses inline ROI computation from recommendations + markets directly.
-- No dependency on recommendation_outcomes table.
-- ============================================================================
